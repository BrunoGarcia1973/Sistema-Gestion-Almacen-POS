...
* **Seguridad y Criptografía:** Implementación de hashing de contraseñas utilizando el algoritmo **BCrypt** para proteger las credenciales de los usuarios en la base de datos, garantizando un almacenamiento seguro.
